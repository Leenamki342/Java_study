...
public class MainFrame3 extends JFrame{
	...
	ActionListener sendListener=new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showMessageDialog(MainFrame3.this,"전송합니다.");
			
		}
	};
	ActionListener updateListener=(e)->{
		JOptionPane.showMessageDialog(MainFrame3.this, "수정합니다.");
	};
	ActionListener deleteListener=(e)->{
		JOptionPane.showMessageDialog(MainFrame3.this, "삭제합니다.");
	};
