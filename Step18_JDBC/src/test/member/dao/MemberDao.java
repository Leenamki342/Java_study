 ...
 *   - DAO 를 만들기 위해서는 DTO 클래스를 미리 설계하고 만들어야 한다.
 *   - 주제(카테고리) 에 관련된 DAO 는 여러개의 Table 의 join 이 일어날 수 있다.
 *     따라서 하나의 Table 당 하나의 DAO 는 아닌것이다.
 *     예를 들어 사원정보를 출력한다고 가정을 한다면
 *     emp, dept, salgrade 3개의 테이블의 join 이 일어날 수 있다.
 *   
 */
