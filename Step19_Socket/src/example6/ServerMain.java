...
public class ServerMain {
	...
	static class ServerThread extends Thread{
		...
		public void sendMessage(String msg) throws IOException { // 이미 Exception 처리 되어있어서 throw 가능
		...
		public void sendChatNameList() {
			...
			// 스레드 목록에서 대화명을 순서대로 참조해서 JSONArray 에 누적시키기
			for(ServerThread tmp:threadList) {
